...
const ComnboSavePage = ({ pageOptions }) => {
    ...
    const { detail, mixinFuncs, loading, onSave, setIsChangedFormValues, isEditing, title, setSubmit } = useSaveBase({
        apiConfig: {
            getById: apiConfig.combo.getById,
            create: apiConfig.combo.create,
            update: apiConfig.combo.update,
        },
        options: {
